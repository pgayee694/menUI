...
public class SignupUsernameTaken {
  ...
  @Test
  public void testSignupUsernameTaken() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Sign up!'])[1]/following::p[1]")).click();
    assertEquals("That username is taken, please try again.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Sign up!'])[1]/following::p[1]")).getText());
  }
