...
public class SignupPasswordsDontMatch {
  ...
  @Test
  public void testSignupPasswordsDontMatch() throws Exception {
    ...
    assertEquals("Your passwords didn't match, please try again.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Sign up!'])[1]/following::p[1]")).getText());
  }
